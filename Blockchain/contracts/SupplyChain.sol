...
contract SupplyChain {
    ...
    function addMedicine(string memory _name, string memory _description, uint256 _quantity, uint256 _basePrice) public {
        medicineCount++;
        medicines[medicineCount] = Medicine(medicineCount, _name, _description, _quantity, _basePrice, msg.sender, false);
